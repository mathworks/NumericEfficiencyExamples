function dispBinIntMantExpAlignInType(varargin)
    %dispBinIntMantExpAlign using base2 exponent and horizontally aligned 
    ...
    dispVarious(struct('preferFormat','IntMantExpAlign','InType',true),varargin{:});
end
