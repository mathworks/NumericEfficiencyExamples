function dispBinPtPreferInType(varargin)
    %dispBinPtPreferInType display of input values in binary point format if not
    ...
    dispVarious(struct('InType',true),varargin{:});
end
